    ...
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            using (logger.EnterSensitiveArea())
            {
                ...
                // Works for destructured log data too
                var demoClass = new DemoClass { Email = "james.bond@universal-exports.co.uk", PublicField = "Double Oh Seven" };
                logger.Information("Logging a destructured class: {@DemoClass}", demoClass);
            }
